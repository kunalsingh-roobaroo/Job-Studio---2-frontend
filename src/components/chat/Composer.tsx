...
export function Composer({ onSend, onStop, isStreaming, disabled, selectedModel, onModelChange }: ComposerProps) {
  ...
  return (
    <div className={cn("absolute bottom-0 left-0 right-0 pl-4 pr-[25px] pb-4 pointer-events-none z-10", hasAnimated && "composer-intro")}>
      <div className="relative w-full pointer-events-auto">
        <div
          className={cn(
            "flex flex-col gap-3 p-3 bg-white border-stone-200 transition-all duration-200 border-none border-0 overflow-hidden relative rounded-3xl",
